<template>
  ...
  <div class="hud-overlay">
    ...
    <div class="hud-topright">
      ...
      <button class="btn-pause" @click="gameStore.togglePause" title="ESC">⏸</button>
    </div>
...
.bar-fill { height: 100%; border-radius: 2px; transition: width 0.12s ease-out; }
...
.hud-room  { font-size: 8px; color: #44ffaa; text-shadow: 0 0 8px rgba(40,220,100,0.5); }
.hud-room.boss { color: #ff6600; animation: bossGlow 1s ease-in-out infinite alternate; }
@keyframes bossGlow { from { opacity: 0.7; } to { opacity: 1; } }
.hud-kills { font-size: 8px; color: #ff8888; }
.hud-time  { font-size: 8px; color: var(--color-gold); }
